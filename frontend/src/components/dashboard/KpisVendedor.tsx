  ...
  return (
    ...
    >
      ...
      <KpiCard
        ...
        valor={(dados.saldoMoedinhas ?? 0).toLocaleString("pt-BR")}
        descricao="Disponível para resgate"
        Icone={Wallet}
        cor="success"
      />
      <KpiCard
        titulo="Total (Moedinhas)"
        // CORRIGIDO: Adicionado `?? 0` para robustez
        valor={(dados.rankingMoedinhas ?? 0).toLocaleString("pt-BR")}
        descricao="Seu acumulado no ranking"
        Icone={Gem}
        cor="primary"
      />
      <KpiCard
